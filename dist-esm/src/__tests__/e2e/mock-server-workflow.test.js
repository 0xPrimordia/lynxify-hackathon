...
describe('Mock Server Workflow E2E', () => {
    ...
    test('should handle rebalance proposal workflow', () => {
        ...
        // Verify the call
        expect(mockProposalHandler.handleMessage).toHaveBeenCalledWith(expect.objectContaining({
            type: 'RebalanceProposal'
        }));
    ...
    test('websocket service should broadcast messages to clients', () => {
        ...
        expect(mockWebsocketService.broadcast).toHaveBeenCalledWith(expect.objectContaining({
            type: 'test',
