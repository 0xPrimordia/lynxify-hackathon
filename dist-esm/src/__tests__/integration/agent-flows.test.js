...
describe('Complete Agent Integration Flows', () => {
    ...
    beforeEach(() => {
        ...
        mockPublishMessage = hederaService.sendMessage;
    ...
    test('Complete Price Update and Rebalance Flow', async () => {
        ...
        const rebalanceProposalPromise = new Promise((resolve) => {
        ...
        const rebalanceApprovalPromise = new Promise((resolve) => {
    ...
    test('Complete Risk Alert and Response Flow', async () => {
        ...
        const riskAlertPromise = new Promise((resolve) => {
    ...
    test('Complete Multi-Agent Communication Flow', async () => {
        ...
        const responseReceivedPromise = new Promise((resolve) => {
