...
async function initializeSubscriptions() {
    ...
    try {
        ...
        await hederaService.subscribeToTopic(governanceTopicId, (message) => {
        ...
        await hederaService.subscribeToTopic(agentTopicId, (message) => {
        ...
        await hederaService.subscribeToTopic(priceFeedTopicId, (message) => {
