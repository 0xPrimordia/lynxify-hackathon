...
export class ProposalHandlerService {
    ...
    async handleProposal(message) {
        ...
        if (this.moonscapeOutboundTopic && this.moonscapeInboundTopic) {
            await hcsMessaging.sendToMoonscape(this.moonscapeOutboundTopic, this.moonscapeInboundTopic, this.operatorId, {
    ...
    async handleAgentRequest(message) {
        ...
        if (requestType === 'status') {
            ...
            if (this.moonscapeOutboundTopic && this.moonscapeInboundTopic) {
                await hcsMessaging.sendAgentStatus(this.moonscapeOutboundTopic, this.moonscapeInboundTopic, this.operatorId, this.pendingProposals.size, this.executedProposals.size);
            }
        }
    }
    /**
