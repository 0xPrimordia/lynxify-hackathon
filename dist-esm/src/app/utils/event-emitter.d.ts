...
export declare class EventBus extends EventEmitter {
     ...
     */
    emitEvent<T extends EventType>(event: T, payload: EventPayloads[T]): boolean;
    /**
     * Listen for a typed event
     */
    onEvent<T extends EventType>(event: T, listener: (payload: EventPayloads[T]) => void): this;
    /**
     * Listen for a typed event once
     */
    onceEvent<T extends EventType>(event: T, listener: (payload: EventPayloads[T]) => void): this;
    /**
     * Remove a typed event listener
     */
    offEvent<T extends EventType>(event: T, listener: (payload: EventPayloads[T]) => void): this;
    /**
