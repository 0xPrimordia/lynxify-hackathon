...
class AIRebalanceAgent {
    ...
    updateMarketData(data) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this.marketData = Object.assign(Object.assign({}, this.marketData), data);
            console.log('🧠 AI AGENT: Market data updated', this.marketData);
        });
    }
    updateTreasuryState(treasury) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    generateRebalanceProposal() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const newWeights = yield this.generatePortfolioAllocation();
                // Create detailed analysis of the proposed changes
                const analysis = yield this.analyzeProposedChanges(newWeights);
    ...
    generatePortfolioAllocation() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const currentTokens = this.supportedTokens.map(token => (Object.assign(Object.assign({}, token), { price: this.marketData.prices[token.symbol] || 100, priceChange: this.marketData.priceChanges[token.symbol] || 0, volume: this.marketData.volumes[token.symbol] || 1000000, volatility: this.marketData.volatility[token.symbol] || 0.05 })));
    ...
    analyzeProposedChanges(newWeights) {
        return __awaiter(this, void 0, void 0, function* () {
            var _a, _b;
    ...
    `;
            try {
                ...
                const analysis = ((_b = (_a = response.choices[0]) === null || _a === void 0 ? void 0 : _a.message) === null || _b === void 0 ? void 0 : _b.content) ||
    ...
    submitRebalanceProposal(newWeights, analysis) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield hedera_1.hederaService.proposeRebalance(newWeights, executeAfter, quorum, 'scheduled', // Using a valid trigger type from the allowed options
            analysis);
            console.log('✅ AI AGENT: Rebalance proposal submitted successfully');
        });
    }
    // Legacy method to maintain compatibility
    checkAndGenerateRebalance() {
        return __awaiter(this, void 0, void 0, function* () {
            const result = yield this.generateRebalanceProposal();
