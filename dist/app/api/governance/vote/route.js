    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    vote = _a.sent();
                    return [4 /*yield*/, hederaService.publishMessage(process.env.NEXT_PUBLIC_GOVERNANCE_TOPIC_ID, vote)];
                case 2:
                    _a.sent();
                    return [2 /*return*/, server_1.NextResponse.json({ status: 'success' })];
                case 3:
                    error_1 = _a.sent();
                    console.error('Error publishing vote:', error_1);
