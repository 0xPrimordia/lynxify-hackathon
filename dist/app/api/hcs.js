...
exports.publishRebalanceProposal = publishRebalanceProposal;
exports.publishRebalanceApproval = publishRebalanceApproval;
...
function publishRebalanceProposal(proposal) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    message = __assign(__assign({}, proposal), { timestamp: Date.now(), sender: 'governance' });
                    return [4 /*yield*/, hederaService.publishMessage(governanceTopicId, message)];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
...
function publishRebalanceApproval(approval) {
    return __awaiter(this, void 0, void 0, function () {
        var governanceTopicId, message;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    governanceTopicId = process.env.NEXT_PUBLIC_GOVERNANCE_TOPIC_ID;
                    message = __assign(__assign({}, approval), { timestamp: Date.now(), sender: 'governance', approvedBy: 'governance' });
                    return [4 /*yield*/, hederaService.publishMessage(governanceTopicId, message)];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
