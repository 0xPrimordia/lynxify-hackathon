        ...
        try {
            ...
            const messagePromise = new Promise((resolve) => {
                openconvai_1.openConvAIService.subscribeToTopic(testTopic, (message) => {
                    ...
                    if (((_a = testMessage.details) === null || _a === void 0 ? void 0 : _a.testId) === testMessageId) {
            ...
            yield openconvai_1.openConvAIService.sendMessage(testTopic, testMessage);
            ...
            try {
                yield Promise.race([messagePromise, timeoutPromise]);
                if (messageReceived) {
            ...
            console.log('✅ Agent Registration:', !!(registrationResult === null || registrationResult === void 0 ? void 0 : registrationResult.success));
            console.log('✅ Topic Subscription:', true);
            console.log('✅ Message Sending:', true);
            console.log('✅ Message Receiving:', messageReceived);
            if ((registrationResult === null || registrationResult === void 0 ? void 0 : registrationResult.success) && messageReceived) {
                console.log('\n🎉 SUCCESS: HCS-10 integration is fully functional');
            }
            else if (registrationResult === null || registrationResult === void 0 ? void 0 : registrationResult.success) {
