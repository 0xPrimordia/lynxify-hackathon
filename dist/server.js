...
function initializeOpenConvAI() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            console.log('🚀 HCS-10: Initializing OpenConvAI agent...');
            // Initialize the OpenConvAI service
            yield openconvai_1.openConvAIService.init();
            // Register the agent with the HCS-10 registry
            console.log('🚀 HCS-10: Registering agent with the HCS-10 registry...');
            const registrationResult = yield openconvai_1.openConvAIService.registerAgent();
            if (registrationResult === null || registrationResult === void 0 ? void 0 : registrationResult.success) {
...
function subscribeToTopicsWithOpenConvAI() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            yield openconvai_1.openConvAIService.subscribeToTopic(governanceTopic, (message) => {
            ...
            yield openconvai_1.openConvAIService.subscribeToTopic(agentTopic, (message) => {
            ...
            yield openconvai_1.openConvAIService.subscribeToTopic(priceFeedTopic, (message) => {
            ...
            if (moonscapeInboundTopic) {
                ...
                yield openconvai_1.openConvAIService.subscribeToTopic(moonscapeInboundTopic, (message) => {
            ...
            if (moonscapeOutboundTopic) {
                ...
                yield openconvai_1.openConvAIService.subscribeToTopic(moonscapeOutboundTopic, (message) => {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            if (moonscapeOutboundTopic) {
                ...
                yield openconvai_1.openConvAIService.sendMessage(moonscapeOutboundTopic, response);
            }
        }
        catch (error) {
...
function subscribeToTopics() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            yield hederaService.subscribeToTopic(governanceTopic, (message) => {
            ...
            yield hederaService.subscribeToTopic(agentTopic, (message) => {
            ...
            yield hederaService.subscribeToTopic(priceFeedTopic, (message) => {
...
function startServer() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const initResult = yield initializeOpenConvAI();
            // Then try to subscribe using OpenConvAI
            const subscribeResult = yield subscribeToTopicsWithOpenConvAI();
...
function sendMoonscapeTestMessage() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            if (!moonscapeOutboundTopic) {
            ...
            yield openconvai_1.openConvAIService.sendMessage(moonscapeOutboundTopic, testMessage);
