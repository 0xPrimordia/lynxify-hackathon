...
class HederaService {
    constructor() {
        ...
        // Message handlers
        this.handlePriceFeedMessage = (message) => __awaiter(this, void 0, void 0, function* () {
        ...
        this.handleGovernanceMessage = (message) => __awaiter(this, void 0, void 0, function* () {
        ...
        this.handleAgentMessage = (message) => __awaiter(this, void 0, void 0, function* () {
    ...
    publishHCSMessage(topicId, message) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                let response;
                try {
                    response = yield transaction.execute(this.client);
    ...
    initializeTopics() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                yield this.subscribeToTopic(process.env.NEXT_PUBLIC_HCS_GOVERNANCE_TOPIC, this.handleGovernanceMessage.bind(this));
                yield this.subscribeToTopic(process.env.NEXT_PUBLIC_HCS_PRICE_FEED_TOPIC, this.handlePriceFeedMessage.bind(this));
                yield this.subscribeToTopic(process.env.NEXT_PUBLIC_HCS_AGENT_TOPIC, this.handleAgentMessage.bind(this));
            }
            catch (error) {
    ...
    // Agent Functions
    processPriceUpdate(price, tokenId) {
        return __awaiter(this, void 0, void 0, function* () {
            const message = {
                id: `price-${Date.now()}`,
                type: 'PriceUpdate',
            ...
            yield this.publishHCSMessage(TOPIC_IDS.MARKET_PRICE_FEED, message);
        });
    }
    assessRisk(priceChange, tokenId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield this.publishHCSMessage(TOPIC_IDS.GOVERNANCE_PROPOSALS, message);
        });
    }
    // Propose a rebalance
    proposeRebalance(newWeights, executeAfter, quorum, trigger, justification) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    approveRebalance(proposalId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield this.publishHCSMessage(process.env.NEXT_PUBLIC_HCS_GOVERNANCE_TOPIC, message);
        });
    }
    ...
    executeRebalance(proposalId, newWeights) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                yield this.publishHCSMessage(process.env.NEXT_PUBLIC_HCS_AGENT_TOPIC, executionMessage);
    ...
    initializeAgents() {
        return __awaiter(this, void 0, void 0, function* () {
            // Price Feed Agent
            yield this.subscribeToTopic(process.env.NEXT_PUBLIC_HCS_PRICE_FEED_TOPIC, (message) => __awaiter(this, void 0, void 0, function* () {
                if (message.type === 'PriceUpdate') {
                    yield this.processPriceUpdate(message.details.price || 0, message.details.tokenId || '');
                }
            }));
                ...
                if (message.type === 'PriceUpdate') {
                    ...
                    if (lastPrice) {
                        ...
                        if (Math.abs(priceChange) >= AGENTS.PRICE_FEED.threshold) {
                            yield this.assessRisk(priceChange, message.details.tokenId || '');
                        }
                    }
                }
            }));
            // Rebalance Agent
            yield this.subscribeToTopic(process.env.NEXT_PUBLIC_HCS_GOVERNANCE_TOPIC, (message) => __awaiter(this, void 0, void 0, function* () {
                if (message.type === 'RebalanceApproved') {
                    const proposal = yield this.getProposal(message.details.proposalId || '');
                    if ((proposal === null || proposal === void 0 ? void 0 : proposal.type) === 'RebalanceProposal') {
                        yield this.executeRebalance(message.details.proposalId || '', proposal.details.newWeights || {});
                    }
                }
            }));
        });
