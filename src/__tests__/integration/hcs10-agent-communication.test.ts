...
describe('HCS-10 Protocol Agent Communication Flows', () => {
  let agent1: LynxifyAgent;
  let agent2: LynxifyAgent;
  let agent3: LynxifyAgent;
  ...
  beforeEach(() => {
    ...
    mockPublishMessage = hederaService.publishMessage as jest.Mock;
  ...
  test('Multi-Agent Registry Communication Flow', async () => {
    ...
    expect(eventBus.emitEvent).toHaveBeenCalledWith(
      EventType.HCS10_AGENT_VERIFIED,
