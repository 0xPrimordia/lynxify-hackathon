...
export class AgentRegistryService {
   ...
   */
  async isAlreadyRegistered(operatorId: string, registryTopic: string): Promise<boolean> {
   ...
   * @param registryTopic The registry topic ID
   */
  private async storeRegistrationStatus(metadata: any, registryTopic: string): Promise<void> {
    try {
      const status = {
   ...
   */
  async getStoredRegistrationInfo(): Promise<{
    accountId: string;
    inboundTopicId: string;
    outboundTopicId: string;
    registryTopic: string;
